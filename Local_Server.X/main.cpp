...
"}while(index<=len);"
"marker=all_dat[1770];"
"if(parseFloat(all_dat[2+(61*29)])<parseFloat(all_dat[20+(61*29)]))//templow\r"
"m_m_arr[0][0]=Math.floor(all_dat[2+(61*29)]);"
" else "
"m_m_arr[0][0]=Math.floor(all_dat[20+(61*29)]);"
"if(parseFloat(all_dat[3+(61*29)])>parseFloat(all_dat[21+(61*29)]))//temphigh\r"
...
"<div>"
"<p id='ld'left='20px'><fontcolor='#818181'>History</font>"
"</p>"
"</div>"
