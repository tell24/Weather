...
//	    putrsUART2("\t1: Change serial number:\t\t");
//		wvTemp.v[1] = AppConfig.MyMACAddr.v[4];
//		wvTemp.v[0] = AppConfig.MyMACAddr.v[5];
//		uitoa(wvTemp.Val, response);
//		putsUART2((char *)response);
		putrsUART2("\r\n\t2: Change host name:\t\t\t");
		putrsUART2((char *)AppConfig.NetBIOSName);
	    ...
	    putrsUART2("\r\n\t8: ");
		putrsUART2((ROM char*)(AppConfig.Flags.bIsDHCPEnabled ? "Dis" : "En"));
		putrsUART2("able DHCP & IP Gleaning:\t\tDHCP is currently ");
		putrsUART2((ROM char*)(AppConfig.Flags.bIsDHCPEnabled ? "enabled" : "disabled"));
...
//					putrsUART2("Settings saved.\r\n");
//				#else
//					putrsUART2("External EEPROM/Flash not present -- settings will be lost at reset.\r\n");
//				#endif
//		        break;
//		}
//	}
