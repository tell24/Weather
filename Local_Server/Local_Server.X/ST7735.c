...
void SPI2_Write(char data) {
    ...
    char temp = SPI2BUF; // dummy read of the SPI1BUF register to clear the SPIRBF flag
    SPI2BUF = data_; // write the data out to the SPI peripheral
