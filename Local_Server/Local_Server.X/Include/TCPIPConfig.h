 ...
 */
#define MY_DEFAULT_HOST_NAME			"LOCALSERVER"
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(1024ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			//{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 24, 24},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 768, 128},
