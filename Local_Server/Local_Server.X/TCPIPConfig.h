 ...
 */
#define MY_DEFAULT_HOST_NAME			"WEATHER"
...
#define MY_DEFAULT_IP_ADDR_BYTE4        (40ul)
...
#define	EMAC_RX_BUFF_SIZE		1024	// size of a RX buffer. should be multiple of 16
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(1204ul)
	#define TCP_PIC_RAM_SIZE					(2700ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 500, 500},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 900, 256},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 900, 256},
